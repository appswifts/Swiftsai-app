        ...
        {menuItems.map((item) => (
          <div
            ...
            className={`
              ...
              ${pathname === item.path || (item.path === '/admin' && pathname?.startsWith('/admin') && pathname !== '/admin/users' && pathname !== '/admin/organizations' && pathname !== '/admin/subscriptions' && pathname !== '/admin/settings')
